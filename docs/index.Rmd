...
gt_table <- stat_emm_plot %>% 
  gt() %>% 
  tab_header(title = "Estimated Marginal Means of Antidepressant Prescriptions by SIMD Quintile across 4 Major Cities", subtitle = "Data obtained from Public Health Scotland") %>%
